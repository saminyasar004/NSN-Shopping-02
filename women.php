...
<head>
    ...
    <title>Women | NSN Shopping | Best E-commerce Shopping Website</title>
    <!-- favicon icon -->
                ...
                <nav>
                    ...
                    <div class="navLinks">
                        <ul>
                            ...
                            <li><a class="activeLink" href="women.php">women</a></li>
    ...
    <section class="productSection">
        ...
        <div class="row">
            <div class="productContainer">
                ...
                $query = "select * from product_info where category = '31'";
