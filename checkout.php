...
<body>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>$<?php echo $cart_whole_price; ?>.00</td>
                  </tr>
                <?php
                }
  ...
  <?php
  // $cart_total_product_id_length = count($cart_total_product_id);
  // $cart_total_product_name_length = count($cart_total_product_name);
  // for ($i = 0; $i < $cart_total_product_id_length; $i++) {
  //   echo $cart_total_product_id[$i] . "<br>";
  // }
  // for ($i = 0; $i < $cart_total_product_name_length; $i++) {
  //   echo $cart_total_product_name[$i] . "<br>";
  // }
  ?>
