 ...
 * updateUsernameExist function use to see if the update form username is taken or not
 ...
 * updateAccountWithPassword function use to update an existing customer account data
