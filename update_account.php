...
if (isset($_REQUEST["submit"])) {
  ...
  // if (updateUsernameExist($connect, $update_username) == false) {
  //   header("location: account_details.php?err=usernameExist");
  //   die();
  // }
  // if (updateEmailExist($connect, $update_email) == false) {
  //   header("location: account_details.php?err=emailExist");
  //   die();
  // }
  /////
